...
public class TimeWeightedReturnServiceTests
{
        ...
        decimal startValue, decimal endValue, decimal netFlow, decimal expectedReturn)
    {
        ...
        // Assert
        Assert.Equal(expectedReturn, result, precision: 4);
    }
    ...
    public void Calculate_MultiplePeriods_ChainReturnsCorrectly()
    {
        ...
        var period1 = new SubPeriod(startValue: 100m, endValue: 110m, netFlow: 0m); // 10% return
        var period2 = new SubPeriod(startValue: 110m, endValue: 121m, netFlow: 0m); // 10% return
        ...
        Assert.Equal(0.21m, result, precision: 4);
    }
    ...
    public void Calculate_MixedReturns_ChainCorrectly()
    {
        ...
        var period1 = new SubPeriod(startValue: 100m, endValue: 120m, netFlow: 0m); // 20% return
        var period2 = new SubPeriod(startValue: 120m, endValue: 108m, netFlow: 0m); // -10% return
        var periods = new[] { period1, period2 };
        ...
        Assert.Equal(0.08m, result, precision: 4);
    }
        ...
        decimal totalReturn, int days, decimal expectedAnnualized)
    {
        ...
        // Assert
        Assert.Equal(expectedAnnualized, result, precision: 3);
    }
