  ...
  useEffect(() => {
    ...
    const verify = async () => {
      ...
      try {
        ...
        setVerificationStatus('error');
        const message = (err as { data?: { message?: string } })?.data?.message || 'Email verification failed. Please try again.';
        ...
        <div className="bg-white dark:bg-gray-800 shadow-md rounded-lg p-8">
          ...
          {verificationStatus === 'success' && (
            <div className="text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">Email Verified Successfully!</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">Your email has been verified. You can now log in to your account.</p>
          ...
          {verificationStatus === 'error' && (
            <div className="text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">Verification Failed</h3>
